{!! Form::open(array('url'=>'asistencia_servicio_social/create','method'=>'GET','autocomplete'=>'off','role'=>'search')) !!}
...
<div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
	  <div class="form-group">
	  	...
	  	<input type="date" name="Fecha" class="form-control" value="{{ old('Fecha',$query_Fecha) }}" placeholder="Fecha...">
	  </div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-lg-1 col-md-2 col-sm-2 l-xs-12"></div>
	...
	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
		<a><img src="{{asset('img/BORRAR.png')}}" type="image/png" height="20px" width="20px"> Borrar </a>
	</div>
</div>
<hr/>
