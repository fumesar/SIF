		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
           		<div class="form-group">
	            	...
	            	<input type="datetime-local" name="updated_at" class="form-control" value="{{$users->updated_at}}" placeholder="Updated At..." disabled>
	            </div>
            </div>
            <div class="form-group text-right">
                <a href="{{URL::action('App\Http\Controllers\Users2Controlador@index')}}" class="btn btn-danger">Volver</a>
            </div>
			{!!Form::close()!!}		
