		...
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12"> 
                  <div class="form-group">
                    ...
                    <input type="file" name="Foto" id="Foto" class="form-control" placeholder="Foto..." accept="image/*" onchange="colocarFoto();">
                  
                    <div class="text-center">
                        <img src="" alt="Sin imagen" height="200px" width="200px" class="img-thumbnail">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
                  	...
                  	<input type="date" name="FechaNacimiento" class="form-control" value="{{ old('FechaNacimiento') }}" placeholder="FechaNacimiento...">
                  </div>
            </div>
        		...
        		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  <option value="">Seleccionar</option>
        					@foreach ($departamento_nacimientos as $departamento_nacimiento)
        						<option 
                    {{ old('idDepartamentoNacimiento') == $departamento_nacimiento->idDepartamentoNacimiento ? 'selected' : '' }}
                    value="{{$departamento_nacimiento->idDepartamentoNacimiento}}">{{$departamento_nacimiento->DepartamentoNacimiento}}</option>
        					@endforeach
        				</select>
        			</div>
        		</div>
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
                  	...
                  	<input type="text" name="CiudadNacimiento" class="form-control" value="{{ old('CiudadNacimiento') }}" placeholder="CiudadNacimiento...">
                  </div>
            </div>
        		...
        		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  <option value="">Seleccionar</option>
        					@foreach ($rhs as $rh)
        						<option {{ old('idRH') == $rh->idRH ? 'selected' : '' }}
                    value="{{$rh->idRH}}">{{$rh->RH}}</option>
        					@endforeach
        				</select>
        			</div>
        		</div>
        		...
        		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  <option value="">Seleccionar</option>
        					@foreach ($nivel_academicos as $nivel_academico)
        						<option {{ old('idNivelAcademico') == $nivel_academico->idNivelAcademico ? 'selected' : '' }}
                      value="{{$nivel_academico->idNivelAcademico}}">{{$nivel_academico->NivelAcademico}}</option>
        					@endforeach
        				</select>
        			</div>
        		</div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
                  	...
                  	<input type="text" name="Barrio" class="form-control" value="{{ old('CiudadNacimiento') }}" placeholder="Barrio...">
                  </div>
            </div>
           </fieldset>
            <style> fieldset { margin: 20px; padding: 0 10px 10px; border: 1px solid #666; border-radius: 8px; box-shadow: 0 0 10px #666; padding-top: 10px; } legend {width:inherit; padding: 2px 4px; background: #fff; /* For better legibility against the box-shadow */ } fieldset > legend { float: left; margin-top: -20px; } fieldset > legend + * { clear: both; } 
        		...
        		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  <option value="">Seleccionar</option>
        					@foreach ($estado_jefaturas as $estado_jefatura)
        						<option {{ old('idEstado') == $estado_jefatura->idEstado ? 'selected' : '' }}
        		...
        		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  <option value="">Seleccionar</option>
        					@foreach ($rangos as $rango)
        						<option {{ old('idRango') == $rango->idRango ? 'selected' : '' }}
        		...
        		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  <option value="">Seleccionar</option>
        					@foreach ($cargos as $cargo)
        						<option {{ old('idCargo') == $cargo->idCargo ? 'selected' : '' }}
                      value="{{$cargo->idCargo}}">{{$cargo->Cargo}}</option>
        					@endforeach
        				</select>
        			</div>
        		</div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
                  	...
                  	<input type="date" name="FechaIngreso" id="FechaIngreso" onchange="calcularAntiguedad();" class="form-control" value="{{ old('FechaIngreso') }}" placeholder="FechaIngreso...">
                  </div>
            </div>
        		...
        		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  ...
                  <option value="">Seleccionar</option>
        					@foreach ($puestos as $puesto)
        						<option {{ old('idPuesto') == $puesto->idPuesto ? 'selected' : '' }}
                      value="{{$puesto->idPuesto}}">{{$puesto->Puesto}}</option>
        					@endforeach
        				</select>
        			</div>
        		</div>
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div class="form-group">
                  	...
                  	<input type="text" name="Antiguedad" id="Antiguedad" class="form-control" value="{{ old('Antiguedad') }}" placeholder="Antiguedad...">
                  </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div id="FechaAscenso" class="form-group">
                  	...
                  	<input type="date" name="FechaAscenso" class="form-control" value="{{ old('FechaAscenso') }}" placeholder="FechaAscenso...">
                  </div>
            </div>
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                  <div id="FechaRetiro" class="form-group">
                  	...
                  	<input type="date" name="FechaRetiro"   class="form-control" value="{{ old('FechaRetiro') }}" placeholder="FechaRetiro...">
                  </div>
            </div>
           </fieldset>                
  			<center>
