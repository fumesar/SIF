    ...
    public function report(Request $request){
        ...
        if ($request){
            ...
            $calificacions=DB::table('matricular')
                ...
                ->select('matricular.idMatricula as idMatricula','jefatura.idJefatura','matricular.Documento','matricular.Nombres as Nombres','matricular.Apellidos as Apellidos',DB::RAW('"" as calificaciones'))
